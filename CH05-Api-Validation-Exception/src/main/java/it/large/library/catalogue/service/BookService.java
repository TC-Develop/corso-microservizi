...
import it.large.library.catalogue.exception.AlreadyExistsException;
...
public class BookService {
    ...
    public BookModel getBook(UUID bookId) {
        ...
        // Eccezione personalizzata di AlreadyExistsException (Vedere ExceptionErrorHandler.class).
    ...
    public BookModel add(BookModel bookModel) {
        ...
        if (isDuplicateBook(bookModel)) {
            // Eccezione personalizzata di AlreadyExistsException (Vedere ExceptionErrorHandler.class).
            throw new AlreadyExistsException("LIBRO GIA' PRESENTE IN ARCHIVIO");
        }
