...
@FeignClient(name = "libraryCatalogueClient", url = "${feign.url.catalogue.host}:${feign.url.catalogue.port}")
public interface CatalogueClient {
    ...
    @RequestMapping(method = RequestMethod.PUT, value = "catalogue/api/v1/book/quantity", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<Boolean> editQuantity(
            @RequestBody List<ExternalBookQuantityRequest> bookQuantityRequestList
    );
